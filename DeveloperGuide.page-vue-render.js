...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new date to the address book.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to provide the date's details, including name, age number, and gender.")]),_v(" "),_c('li',[_v("User enters the required details.")]),_v(" "),_c('li',[_v("AddressBook validates the input.")]),_v(" "),_c('li',[_v("AddressBook adds the new date to the address book.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("AddressBook shows an error message.")]),_v(" "),_c('li',[_v("User is prompted to re-enter the details.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to search for a date in the address book.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to enter a search query (e.g., name or age number).")]),_v(" "),_c('li',[_v("User enters the search query.")]),_v(" "),_c('li',[_v("AddressBook performs a search based on the query.")]),_v(" "),_c('li',[_v("AddressBook displays a list of dates matching the search query.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that no matching dates were found.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to edit the details of a specific date.")]),_v(" "),_c('li',[_v("AddressBook shows a list of dates.")]),_v(" "),_c('li',[_v("User selects the date they want to edit from the list.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to provide the updated details for the selected date.")]),_v(" "),_c('li',[_v("User enters the updated details.")]),_v(" "),_c('li',[_v("AddressBook validates the input.")]),_v(" "),_c('li',[_v("AddressBook updates the date's details with the new information.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no dates to edit.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid date.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook shows an error message.")]),_v(" "),_c('li',[_v("User is prompted to re-enter the details.")]),_v(" "),_c('li',[_v("Use case resumes at step 5.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to view the details of a specific date.")]),_v(" "),_c('li',[_v("AddressBook shows a list of dates.")]),_v(" "),_c('li',[_v("User selects the date they want to view from the list.")]),_v(" "),_c('li',[_v("AddressBook displays the date's details, including name, age number, and gender.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no dates to view.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid date.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to delete a specific date from the address book.")]),_v(" "),_c('li',[_v("AddressBook shows a list of dates.")]),_v(" "),_c('li',[_v("User selects the date they want to delete from the list.")]),_v(" "),_c('li',[_v("AddressBook confirms the deletion with the user.")]),_v(" "),_c('li',[_v("User confirms the deletion.")]),_v(" "),_c('li',[_v("AddressBook deletes the date from the address book.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no dates to delete.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid date.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Usability and Accessibility: The application should provide clear and user-friendly CLI prompts and menus.\nIt should support keyboard shortcuts for navigation to enhance accessibility.")]),_v(" "),_c('li',[_v("Scalability: The address book should be capable of storing at least 10,000 contacts without a significant decrease in performance.")]),_v(" "),_c('li',[_v("Reliability and Availability: The application should have a 99.9% uptime, ensuring that users can access their contacts reliably.\nIt should automatically back up address book data daily to prevent data loss.")]),_v(" "),_c('li',[_v("Portability: The CLI application should be compatible with multiple operating systems, including Windows, macOS, and Linux.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sun, 8 Oct 2023, 12:57:21 GMT+8]")])])])}
}];

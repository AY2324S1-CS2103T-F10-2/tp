...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new person to the address book.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to provide the person's details, including name, phone number, and email.")]),_v(" "),_c('li',[_v("User enters the required details.")]),_v(" "),_c('li',[_v("AddressBook validates the input.")]),_v(" "),_c('li',[_v("AddressBook adds the new person to the address book.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to search for a person in the address book.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to enter a search query (e.g., name or phone number).")]),_v(" "),_c('li',[_v("User enters the search query.")]),_v(" "),_c('li',[_v("AddressBook performs a search based on the query.")]),_v(" "),_c('li',[_v("AddressBook displays a list of persons matching the search query.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that no matching persons were found.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to edit the details of a specific person.")]),_v(" "),_c('li',[_v("AddressBook shows a list of persons.")]),_v(" "),_c('li',[_v("User selects the person they want to edit from the list.")]),_v(" "),_c('li',[_v("AddressBook prompts the user to provide the updated details for the selected person.")]),_v(" "),_c('li',[_v("User enters the updated details.")]),_v(" "),_c('li',[_v("AddressBook validates the input.")]),_v(" "),_c('li',[_v("AddressBook updates the person's details with the new information.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no persons to edit.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid person.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to view the details of a specific person.")]),_v(" "),_c('li',[_v("AddressBook shows a list of persons.")]),_v(" "),_c('li',[_v("User selects the person they want to view from the list.")]),_v(" "),_c('li',[_v("AddressBook displays the person's details, including name, phone number, and email.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no persons to view.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid person.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to delete a specific person from the address book.")]),_v(" "),_c('li',[_v("AddressBook shows a list of persons.")]),_v(" "),_c('li',[_v("User selects the person they want to delete from the list.")]),_v(" "),_c('li',[_v("AddressBook confirms the deletion with the user.")]),_v(" "),_c('li',[_v("User confirms the deletion.")]),_v(" "),_c('li',[_v("AddressBook deletes the person from the address book.")]),_v(" "),_c('li',[_v("AddressBook displays a confirmation message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays a message indicating that there are no persons to delete.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("AddressBook displays an error message.")]),_v(" "),_c('li',[_v("User is prompted to select a valid person.")]),_v(" "),_c('li',[_v("Use case resumes at step 3.")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 7 Oct 2023, 15:49:24 GMT+8]")])])])}
}];
